# Historical `RandomMap2.lean` Phase 5–10 draft

This is the verbatim non-elaborating Phase 5–10 tail preserved from the original Lean file.
It is kept as historical material because several declarations use obsolete APIs or state invalid proposals.
