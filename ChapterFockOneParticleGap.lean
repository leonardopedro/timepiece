...
vacuum energy and the odd sector ground value is the lowest one-particle energy.  That
...
sector ground value is the vacuum energy `0` (`hvac`) and the odd sector ground value is
