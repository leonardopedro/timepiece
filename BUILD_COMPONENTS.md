...
### `BookProof` — 915 modules, 112 independent parts (27 with more than one module)

| modules | Lake target | maximal modules (the `roots` of the target) |
| ---: | --- | --- |
| 517 | `BookProofOperatorCore` | `BookProof.ChapterAbelianCyclicCommutant`, `BookProof.ChapterAbelianMixture`, `BookProof.ChapterBddBelowFiberSumEsa`, `BookProof.ChapterBornMeasure`, `BookProof.ChapterBrstUnboundedLeakage`, `BookProof.ChapterCarlemanGeneralHop`, … (77 in total) |
